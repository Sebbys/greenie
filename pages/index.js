...
export default function Home() {
  return (
    <div className="grid">
      <header className="bg-white">
        <nav className="container p-6 mx-auto lg:flex lg:justify-between lg:items-center">
          ...
          <div className="flex flex-col mt-4 space-y-2 lg:mt-0 lg:flex-row lg:-px-8 lg:space-y-0">
            <Link href="">
              <a className="mx-8 text-gray-700 transition-colors duration-200 transform hover:text-green-500">
                Home
              </a>
            </Link>
            <Link href="#features">
          ...
          <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg">
                ...
                <button className="w-full px-3 py-2 mt-6 text-xs font-medium text-white uppercase transition-colors duration-200 transform bg-green-600 rounded-md lg:w-auto hover:bg-green-500 focus:outline-none focus:bg-green-500">
                  Shop Now
                </button>
              </div>
            </div>
      ...
      <section id="our-team" className="bg-gray-100">
        <div className="container px-6 py-10 mx-auto">
